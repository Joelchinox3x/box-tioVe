...
<?php
$bcp_path  = PROJECT_ROOT . '/assets/img/bcp.png';
$bbva_path = PROJECT_ROOT . '/assets/img/bbva.png';
?>
...
<table class="items-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td align="center">S/. <?= number_format($it['price'], 2) ?></td>
            <td align="center">S/. <?= number_format($it['subtotal'], 2) ?></td>
        </tr>
        <?php endforeach; ?>
        ...
        <tr>
            ...
            <td class="total-value">S/. <?= number_format($totals['subtotal'], 2) ?></td>
        </tr>
        <tr>
            <td colspan="2" style="border:none;"></td>
            <td class="total-label" style="border-bottom: 1px solid white;">IGV (18%)</td>
            <td class="total-value">S/. <?= number_format($totals['igv'], 2) ?></td>
        </tr>
        <tr>
            <td colspan="2" style="border:none;"></td>
            <td class="total-label">TOTAL</td>
            <td class="total-value">S/. <?= number_format($totals['total'], 2) ?></td>
        </tr>
                </tbody>
</table>
