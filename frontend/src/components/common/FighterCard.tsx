...
export const FighterCard = forwardRef<View, FighterCardProps>(({
    fighter,
    variant = 'large',
    onPress,
    showBadge = true,
    ...
    const largeCardHeight = (Platform.OS === 'web' ? webWidth : cardWidth) / 1.9;
    ...
    return (
        <View ref={ref} collapsable={false} style={{ width: finalWidth as any, alignSelf }}>
            <ContainerComponent
                style={[
                    styles.container,
                    { width: '100%', marginVertical: 0 },
                    style
                ]}
                onPress={onPress}
                activeOpacity={0.9}
                ...
                <View style={[styles.card, { height: finalHeight, borderColor: borderColor }]}>
                    ...
                    >
                        ...
                        {record && variant !== 'small' && (() => {
                            ...
                            return (
                                <View style={[styles.recordBadge, styles.recordBadgeBottomRight, { borderColor: themeColor }]}>
                                    <Text style={[styles.recordLabel, { color: themeColor }]}>RÉCORD</Text>
                                    <View style={styles.recordRow}>
                                        <Text style={[styles.recordNumber, styles.recordNumberWin]}>{wins}</Text>
                                        <Text style={[styles.recordNumber, styles.recordNumberLoss]}>{losses}</Text>
                                        <Text style={[styles.recordNumber, styles.recordNumberDraw]}>{draws}</Text>
                                    </View>
                                </View>
                            );
                        })()}
